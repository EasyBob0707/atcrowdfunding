			  ...
			  <div class="panel-body">
				<form id="updateForm">
				  <div class="form-group">
				  	<%-- <input id="fid" type="hidden" value="${manager.id }"/> --%>
					<label for="exampleInputPassword1">登录账号</label>
					<input type="text" class="form-control" id="floginacct" value="${manager.loginacct}" placeholder="请输入登陆账号">
				  </div>
				  <div class="form-group">
					<label for="exampleInputPassword1">用户名称</label>
					<input type="text" class="form-control" id="fusername" value="${manager.username}" placeholder="请输入用户名称">
				  </div>
				  <div class="form-group">
					<label for="exampleInputEmail1">邮箱地址</label>
					<input type="email" class="form-control" id="femail" value="${manager.email}" placeholder="请输入邮箱地址">
	...
	<script src="${APP_PATH}/jquery/layer/layer.js"></script>
        <script type="text/javascript">
            ...
            $("#resetBtn").click(function(){
            	//DOM对象中含有reset()函数,jquery中没有reset()函数
		    	$("#updateForm")[0].reset(); 
		    });
		    ...
		    $("#updateBtn").click(function() {
		    	...
		    	$.ajax({
		    		type : "POST",
		    		url : "${APP_PATH}/manager/doEdit.do",
		    		data : {
		    		...
		    		success:function(result){
		    			...
		    			if(result.success){
		    				...
		    				window.location.href="${APP_PATH}/manager/index.htm?pageno="+${param.pageno};
		    			}else{
