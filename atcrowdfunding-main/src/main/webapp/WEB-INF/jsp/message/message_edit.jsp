			  ...
			  <div class="panel-body">
				<form role="form" id="editForm">
				  ...
				  <div class="form-group">
					...
					<input type="email" class="form-control" id="fcontent" value="${message.content }">
				  </div>
	...
	<script src="${APP_PATH}/jquery/layer/layer.js"></script>
        <script type="text/javascript">
            ...
            $("#reset_btn").click(function(){
            	$("#editForm")[0].reset(); //DOM对象中含有reset()函数,jquery中没有reset()函数
            });
            ...
            $("#edit_btn").click(function(){
            	...
            	if($.trim(content) != ""){
            		$.ajax({
                		type:"post",
                		url:"${APP_PATH}/message/doEdit.do",
                		data:{
                		...
                		success:function(result){
                			...
                			if(result.success){
                				...
                				window.location.href="${APP_PATH}/message/index.htm";
                			}else{
            		...
            		layer.msg("修改值不能为空!", {time:2000, icon:5, shift:6});
            	}
