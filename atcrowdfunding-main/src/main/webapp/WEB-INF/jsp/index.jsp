 ...
 <div class="navbar-wrapper">
      <div class="container">
            ...
            <div id="navbar" class="navbar-collapse collapse" style="float:right;">
              <c:if	test="${empty sessionScope.loginMember.username }">
              		<ul class="nav navbar-nav navbar-right">
                		<li><a href="${APP_PATH}/toLogin.htm">登录</a></li>
                		<li><a href="${APP_PATH}/toReg.htm">注册</a></li>
              		</ul>
              </c:if>
	          <c:if test="${not empty sessionScope.loginMember.username }">
	              <ul class="nav navbar-nav navbar-right">
		          		<li style="padding-top:8px;">
							<div class="btn-group">
								  <button type="button" class="btn btn-default btn-success dropdown-toggle" data-toggle="dropdown">
										<i class="glyphicon glyphicon-user"></i> ${sessionScope.loginMember.username } <span class="caret"></span>
								  </button>
								  <ul class="dropdown-menu" role="menu">
									<li><a href="#"><i class="glyphicon glyphicon-cog"></i> 个人设置</a></li>
									<li><a href="#"><i class="glyphicon glyphicon-comment"></i> 消息</a></li>
									<li class="divider"></li>
									<li><a href="${APP_PATH}/memberLogout.htm"><i class="glyphicon glyphicon-off"></i> 退出系统</a></li>
								  </ul>
						   	 </div>
			    		</li>
				   </ul>
