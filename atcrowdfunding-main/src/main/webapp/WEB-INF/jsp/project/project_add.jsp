			...
			<div class="panel panel-default">
			  ...
			  <div class="panel-body">
				<form role="form" id="updateForm">
				  ...
				  <button id="add_btn" type="button" class="btn btn-success"><i class="glyphicon glyphicon-plus"></i> 新增</button>
			    	...
			    	$.ajax({
			    		...
			    		success:function(result){
			    			...
			    			if(result.success){
			    				...
			    				window.location.href=("${APP_PATH}/project/toProjectType.htm");
			    			}else{
			    				layer.msg(result.errorMessage, {time:2000, icon:5, shift:6});
			    			}
			    		},
			    		error:function(){
			    			layer.msg("error添加失败", {time:2000, icon:5, shift:6});
			    		}
			    	});
