			    		...
			    		$.ajax({
				    		...
				    		success : function(result){
				    			...
				    			if (result.success) {
									...
									layer.msg("修改角色名称失败!", {time:2000, icon:5, shift:6});
								}
				    		},
				    		error : function(){
				    			layer.msg("修改操作失败!", {time:2000, icon:5, shift:6});
				    		}
				    	});
				    	return ;
					}else{
						layer.msg("角色名不能为空，修改失败", {time:2000, icon:5, shift:6});
					}
