			  ...
			  <div class="panel-body">
				<form id="updateForm">
				   <div class="form-group">
					<label for="fpermisionname">许可名称</label>
					<input type="text" class="form-control" id="fpermisionname" value="${permission.name }" placeholder="请输入许可名称">
				  </div>
				  <div class="form-group">
					<label for="fpermissionurl">许可URL</label>
					<input type="text" class="form-control" id="fpermissionurl" value="${permission.url }" placeholder="请输入许可URL">
				  </div>
            ...
            $(function () {
			    ...
			    $("#updateBtn").click(function(){
			    	...
			    	$.ajax({
			    		...
			    		data:{
			    			"name":$("#fpermisionname").val(),
			    			"url":$("#fpermissionurl").val(),
			    			"id":"${permission.id}" /* 放到单引号中与不放没有太多区别, 只是避免报错 */
			    		},
			    		beforeSend:function(){
