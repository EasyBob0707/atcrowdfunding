			  ...
			  <div class="panel-body">
				<form>
				  <div class="form-group">
					...
					<input type="text" class="form-control" id="fname" placeholder="请输入参数名称">
				  </div>
				  <div class="form-group">
					<label for="exampleInputPassword1">代码</label>
					<input type="text" class="form-control" id="fcode" placeholder="请输入代码">
				  </div>
				  <div class="form-group">
					<label for="exampleInputEmail1">数值</label>
					<input type="text" class="form-control" id="fval" placeholder="请输入数值">
				  </div>
