...
<body>
			...
			<div id="navbar" class="navbar-collapse collapse">
				<ul class="nav navbar-nav navbar-right">
					<li style="padding-top: 8px;"><%@include
							file="/WEB-INF/jsp/common/managerinfo.jsp"%>
					</li>
				...
				<div class="panel panel-default">
					...
					<div class="panel-body">
						...
						<button type="button" class="btn btn-primary"
							style="float: right;" onclick="window.location.href='${APP_PATH}/advertisement/add.htm'">
	...
	<script type="text/javascript">
            ...
            function changePageno( pageno ) {
            	//window.location.href = "<%=request.getContextPath() %>/advertisement/index.htm?pageno="+pageno;
            	queryPage(pageno-1);
            }
            ...
            function queryPage( pageIndex ){
            	...
            	$.ajax({
            		...
            		url : "${APP_PATH}/advertisement/pageQuery.do",
            		type : "post",
            		data : dataObj,
            		beforeSend : function(){
            		...
            		success : function(result){
            			...
            			if(result.success){
            				...
            				$.each(list,function(i,n){
								...
								content+="	<td>";
								content+="		<button type='button' onclick='window.location.href=\"${APP_PATH}/advertisement/edit.htm?pageno="+pageObj.pageno+"&id="+n.id+"\"' class='btn btn-primary btn-xs'>";
            ...
            function deleteAdvert(id,name){
    			...
    			layer.confirm("是否要删除广告?",  {icon: 3, title:'提示'}, function(cindex){
    				...
    				$.ajax({
    					url : "${APP_PATH}/advertisement/delete.do",
    					type : "POST",
    					data : {id:id},
    					success : function(result){
    						if(result.success){
