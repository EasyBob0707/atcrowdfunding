			  ...
			  <div class="panel-body">
				<form id="updateForm">
				  <div class="form-group">
					...
					<input type="text" class="form-control" id="name" value="${advertisement.name }" placeholder="请输入广告名称">
				  </div>
				  <div class="form-group">
					<label for="url">广告地址</label>
					<input type="text" class="form-control" id="url" value="${advertisement.url }" placeholder="请输入广告地址">
				  </div>
				  <div class="form-group">
				  	<img alt="广告图片" height="300px" width="300px" src="${advertisement.iconpath }">
            ...
            $(function(){
            	$("#updateBtn").click(function(){
                	...
                	$.ajax({
                		...
                		url : "${APP_PATH}/advertisement/update.do",
                		type : "POST",
                		data : {
                			name : $("#name").val(),
                			url : $("#url").val(),
